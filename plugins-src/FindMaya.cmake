...
elseif(APPLE)
  set(MAYA_INSTALL_BASE_DEFAULT "/Applications/Autoesk")
...
set(MAYA_LOCATION ${MAYA_INSTALL_BASE_PATH}/maya${MAYA_INSTALL_BASE_SUFFIX})
...
function(MAYA_PLUGIN _target)
  ...
  set_target_properties(${_target} PROPERTIES
    COMPILE_DEFINITIONS "${MAYA_PLUGIN_DEFINITIONS}"
    PREFIX ""
