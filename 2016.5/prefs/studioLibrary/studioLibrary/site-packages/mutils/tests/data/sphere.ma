...
//Name: sphere.ma
//Last modified: Thu, Jun 26, 2014 10:52:25 AM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.651971993533335 11.749498459162144 57.150130640744543 ;
	setAttr ".r" -type "double3" -8.1383527296083482 -5.7999999999981435 9.9903770284924978e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 58.143798736108003;
...
createNode transform -n "offset" -p "group";
	...
	setAttr -l on ".sy";
	setAttr -l on ".sz";
createNode transform -n "sphere" -p "offset";
